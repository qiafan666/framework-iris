...
import (
	...
	"framework-iris/gota/iris"
	"framework-iris/gota/redis"
...
// GetgotaInstance create the single object
func GetgotaInstance() *Server {
	return Instance
}
...
//func (slf *Server) FeatureDB(name string) *gotadb.gotaDB {
